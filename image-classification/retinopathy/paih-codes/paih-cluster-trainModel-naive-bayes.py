...
model_nb.write().overwrite().save('hdfs://192.168.65.188:8020/paih/model-naive-bayes')
...
print("Train Data set accuracy with Naive Bayes = " + str(evaluator.evaluate(predictionAndLabels)) + " and error " + str(1 - evaluator.evaluate(predictionAndLabels)))
