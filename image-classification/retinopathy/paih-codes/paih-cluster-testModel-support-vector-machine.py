...
model_svm = OneVsRestModel.load('hdfs://192.168.65.188:8020/paih/support-vector-machine')
...
print("Test Data set accuracy with support-vector-machine  = " + str(evaluator.evaluate(predictionAndLabels)) + " and error " + str(1 - evaluator.evaluate(predictionAndLabels)))
